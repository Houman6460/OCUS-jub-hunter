...
export const translations: Record<string, Translations> = {
  en: {
    ...
    // Free Demo Section
    freeDemoTitle: "Try the Demo Version for Free",
    freeDemoSubtitle: "Test our extension with 3 free missions before upgrading to unlimited access",
    freeDemoBadge: "100% Free Trial",
    freeDemoFeature1: "3 Free Mission Tests",
    freeDemoFeature2: "Full Extension Features",
    freeDemoFeature3: "No Credit Card Required",
    freeDemoFeature4: "Instant Download",
    freeDemoDownloadButton: "Download Free Demo",
    freeDemoUpgradeText: "Love it? Upgrade to unlimited access anytime",
    freeDemoTestText: "Perfect for testing before purchase",
    
    // Purchase Card Features
    chromeExtensionFile: "Chrome Extension (.crx file)",
    autoLoginOcus: "Auto-login for OCUS account",
    jobMonitoringSystem: "24/7 job monitoring system",
    desktopNotifications: "Instant desktop notifications",
    performanceAnalytics: "Performance analytics & statistics",
    installationManual: "Installation manual included",
    lifetimeUpdatesSupport: "Lifetime access",
    securePayment: "Secure payment via Stripe & PayPal",
